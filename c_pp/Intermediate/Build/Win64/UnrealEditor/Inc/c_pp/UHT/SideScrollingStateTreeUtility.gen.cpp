...
C_PP_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData();
C_PP_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerTask();
...
class UScriptStruct* FStateTreeGetPlayerInstanceData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData, (UObject*)Z_Construct_UPackage__Script_c_pp(), TEXT("StateTreeGetPlayerInstanceData"));
	}
...
class UScriptStruct* FStateTreeGetPlayerTask::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerTask, (UObject*)Z_Construct_UPackage__Script_c_pp(), TEXT("StateTreeGetPlayerTask"));
	}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_gitt_c_pp_c_pp_Source_c_pp_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_c_pp_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FStateTreeGetPlayerInstanceData::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData_Statics::NewStructOps, TEXT("StateTreeGetPlayerInstanceData"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerInstanceData), 1248150679U) },
		{ FStateTreeGetPlayerTask::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerTask_Statics::NewStructOps, TEXT("StateTreeGetPlayerTask"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerTask), 1410159918U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_gitt_c_pp_c_pp_Source_c_pp_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_c_pp_2818914819(TEXT("/Script/c_pp"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_gitt_c_pp_c_pp_Source_c_pp_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_c_pp_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_gitt_c_pp_c_pp_Source_c_pp_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_c_pp_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
